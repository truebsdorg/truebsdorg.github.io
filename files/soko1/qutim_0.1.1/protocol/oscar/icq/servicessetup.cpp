...
servicesSetup::servicesSetup(const QString &u) : icqUin(u)
{
	flap0202seq = 0;
	snac0202seq = 0;
	flap0204seq = 0;
...
QByteArray servicesSetup::icq5Capab()
{
	...
	packet.append(QByteArray::fromHex("094600004c7f11d18222444553540000"));
...
#endif
	//off version
	clientId.append(convertToByteArray((quint8)QUTIM_BUILD_VERSION_MAJOR));
	clientId.append(convertToByteArray((quint8)QUTIM_BUILD_VERSION_MINOR));
	clientId.append(convertToByteArray((quint8)QUTIM_BUILD_VERSION_SECMINOR));
	
	//svn version
	clientId.append(convertToByteArray((quint16)QUTIM_SVN_REVISION));
