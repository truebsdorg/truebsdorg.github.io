...
public:
    userInformation(bool, bool, const QString &,const QString &, QWidget *parent = 0);
    ~userInformation();
    ...
    void setAdditional(quint32,quint32,quint32,quint32,quint32, const QString &, const QList<QByteArray> &, const QList<quint16> &, quint32, quint32, quint32, bool, quint8,quint32,
    		quint32);
